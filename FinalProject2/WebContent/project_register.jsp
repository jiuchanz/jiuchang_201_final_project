						...
						<!-- One -->
							<section id="one">
								<div class="container">
									...
									<div class="features">
										<article>
											<form method="post" action="project_register" onsubmit = "send()">
												<div class="row uniform">
													<div class="12u"><input type="text" name="projectname" id="pname" placeholder="Project Name" required/></div>
												</div><hr/>
												...
												<fieldset><legend id="legendTitle">Programming:		<a href="javascript:showOrHide1();"><i class="glyphicon glyphicon-chevron-down"></i></a></legend>
													<div id="showorhide1" style="display:block;">
												...
												Abstract:
												<div class="row uniform">
													<div class="12u"><input type="text" name="abstract" id="abstract" placeholder="A short sentence describing the project" required/></div>
												</div><br/>
												...
												<div class="row uniform">
													...
													<div class="6u 12u(xsmall)"><input type="text" name="fname" id="fname" value="<%=fname%>" /></div>
													<div class="6u 12u(xsmall)"><input type="text" name="lname" id="lname" value = "<%=lname%>"/></div>
													<div class="12u"><input type="text" name="email" id="email" value = "<%=email%>"/></div>
												</div><hr/>
												<div class="row uniform">
													<div class="12u">
														<ul class="actions">
